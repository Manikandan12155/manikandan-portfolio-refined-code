...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 w-24 h-24 bg-secondary/10 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-4xl font-bold text-slate-900 mb-4 text-gradient">About Me</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 animate-fade-in-up">
          {stats.map((stat, index) => (
            <div 
              key={index} 
              className="text-center p-6 bg-gradient-to-br from-primary/5 to-secondary/10 rounded-lg hover-lift animate-scale-in"
            ...
            >
              ...
              <div className="text-3xl font-bold text-primary mb-1 animate-bounce-in">
                {stat.number}
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in-left">
            <h3 className="text-2xl font-semibold text-slate-900 mb-6 hover:text-primary transition-colors duration-300">
              My Story
            </h3>
            ...
            <div className="mt-8 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
              ...
              <ul className="space-y-3 text-slate-700">
                {[
                  ...
                  >
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0 group-hover:animate-pulse"></span>
          ...
          <div className="space-y-6 animate-fade-in-right">
            {achievements.map((achievement, index) => (
              <Card 
                key={index} 
                className="card-hover group relative overflow-hidden animate-slide-in-right"
              ...
              >
                ...
                <CardHeader className="relative z-10">
                  <div className="flex items-center space-x-3">
                    <div className="p-2 bg-primary/10 rounded-full group-hover:bg-primary/20 transition-colors duration-300 animate-bounce-in">
                      {achievement.icon}
                    </div>
                ...
                {/* Decorative Elements */}
                <div className="absolute top-4 right-4 w-8 h-8 bg-primary/5 rounded-full animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="absolute bottom-4 left-4 w-6 h-6 bg-secondary/10 rounded-full animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
              </Card>
            ))}
          </div>
        </div>
        ...
        <div className="mt-16 text-center animate-fade-in-up">
          <div className="max-w-4xl mx-auto p-8 bg-gradient-to-r from-primary/5 to-secondary/10 rounded-2xl border border-primary/10 hover-glow">
            <blockquote className="text-xl md:text-2xl font-medium text-slate-700 italic mb-4 animate-shimmer">
              "Code is like humor. When you have to explain it, it's bad."
            </blockquote>
            <cite className="text-primary font-semibold">- Cory House</cite>
